...
/**
 * Proxy method interceptor that records invoked methods.
 */
class SubmatcherMethodInterceptor implements MethodInterceptor
{
	// ----------------------------------------------------------------------------------------------------------------
	// fields
	// ----------------------------------------------------------------------------------------------------------------
	...
	public Object intercept(Object obj, Method method, Object[] args, MethodProxy proxy) throws NoSuchMethodException
	{
